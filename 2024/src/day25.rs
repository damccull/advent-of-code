...
fn main() -> Result<(), anyhow::Error> {
    let data = include_str!("../data/day25.txt");
    let result = crate::puzzle1(data).unwrap();
    println!("Day 25 Puzzle 1: {}", result);

    let result = crate::puzzle2(data).unwrap();
    println!("Day 25 Puzzle 2: {}", result);
    Ok(())
}
...
mod tests {
    ...
    #[test]
    fn puzzle1() {
        let data = include_str!("../data/d25p1-test.txt");
    ...
    #[test]
    fn puzzle2() {
        let data = include_str!("../data/d25p2-test.txt");
